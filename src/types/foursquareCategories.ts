export const foursquareCategories = [
  ...
  {
    id: '61z47hyjv8bxwp1x6ca4mruw',
    name: 'Contemporary Restaurant',
    pluralName: 'Contemporary Restaurants',
  ...
  {
    id: 'tmw0tvsk956aauktcomz98n1',
    name: 'European Restaurant',
    pluralName: 'European Restaurants',
    shortName: 'European',
    icon: {
      prefix: 'https://ss3.4sqi.net/img/categories_v2/food/default_',
      suffix: '.png',
  ...
  {
    id: 'y5qf5ugb1i52s5mbtw67ufwn',
    name: 'Welsh Cuisine',
    pluralName: 'Welsh Cuisine',
    shortName: 'Welsh',
    icon: {
      prefix: 'https://ss3.4sqi.net/img/categories_v2/food/default_',
      suffix: '.png',
  ...
  {
    id: '0ezw42c80fccbbco5rnh00xm',
    name: 'Irish Cuisine',
    pluralName: 'Irish Cuisine',
    shortName: 'Irish',
    icon: {
      prefix: 'https://ss3.4sqi.net/img/categories_v2/food/default_',
      suffix: '.png',
  ...
  },
  {
    ...
    pluralName: 'British Restaurants',
    shortName: 'British',
    icon: {
      prefix: 'https://ss3.4sqi.net/img/categories_v2/food/default_',
      suffix: '.png',
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        icon: {
          prefix:
            'https://ss3.4sqi.net/img/categories_v2/shops/food_fishmarket_',
          suffix: '.png',
        },
        categories: [],
      },
        ...
        categories: [
          {
            ...
            icon: {
              prefix:
                'https://ss3.4sqi.net/img/categories_v2/food/argentinian_',
              suffix: '.png',
            },
            categories: [],
          },
            ...
            categories: [
              {
                ...
                icon: {
                  prefix:
                    'https://ss3.4sqi.net/img/categories_v2/food/peruvian_',
                  suffix: '.png',
                },
                categories: [],
              },
  ...
  },
  {
    ...
    icon: {
      prefix:
        'https://ss3.4sqi.net/img/categories_v2/food/moleculargastronomy_',
      suffix: '.png',
    },
    categories: [],
  },
  {
    id: '63b840026649ebe8ff73f61a',
    name: 'Nepalese Restaurant',
    pluralName: 'Nepalese Restaurants',
    shortName: 'Nepalese',
    icon: {
      prefix: 'https://ss3.4sqi.net/img/categories_v2/food/default_',
      suffix: '.png',
  ...
  },
  {
    ...
    pluralName: 'Vegetarian Restaurants',
  ...
  {
    id: '4bf58dd8d48988d1d3941985',
    name: 'Vegan Restaurant',
    pluralName: 'Vegan Restaurants',
    shortName: 'Vegan',
    icon: {
      prefix: 'https://ss3.4sqi.net/img/categories_v2/food/vegetarian_',
      suffix: '.png',
  ...
  {
    id: '4bf58dd8d48988d1d6942901',
    name: 'Artisan Bakery',
    pluralName: 'Artisan Bakery',
    shortName: 'Artisan Bakery',
    icon: {
      suffix: '.png',
    },
    categories: [],
